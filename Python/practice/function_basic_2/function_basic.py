...
# Print and Return - Create a function that will receive a list with two numbers. Print the first value and return 
# the second.
...
# from the original list that are greater than its 2nd value. Print how many values this is and then return the 
# new list. If the list has less than 2 elements, have the function return False
